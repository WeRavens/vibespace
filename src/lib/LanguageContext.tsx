...
const translations = {
  ...
  failedUpdateDescription: {
    id: "Gagal mengubah deskripsi",
  ...
  deleteUserSuccess: {
    id: "User berhasil dihapus dari aplikasi.",
    en: "User was deleted from the app successfully.",
  },
  deleteUserFailed: {
  ...
  noTrendingData: {
    id: "Belum ada data trending.",
    en: "No trending data yet.",
  },
  liveFeed: { id: "Feed Langsung", en: "Live Feed" },
  noIncomingBroadcast: {
    id: "Belum ada siaran masuk.",
    en: "No incoming broadcast.",
  },
  searchUsersOrVibes: {
    id: "Cari user atau vibe...",
    en: "Search users or vibes...",
  },
  searchingUniverse: {
    id: "Mencari di semesta...",
    en: "Searching the universe...",
  },
  noVibesFound: {
    id: 'Tidak ada vibe untuk "{term}"',
    en: 'No vibes found for "{term}"',
  },
  ...
  activityBy: {
    id: "Aktivitas baru dari {name}",
    en: "New activity from {name}",
  },
  reactedToPost: {
    id: "{name} memberikan reaksi {text} pada postinganmu.",
    en: "{name} reacted with {text} to your post.",
  },
  commentedOnPost: {
    id: '{name} baru saja berkomentar: "{text}"',
    en: '{name} just commented: "{text}"',
  },
  justNow: { id: "baru saja", en: "just now" },
  expressionWithoutPerfection: {
    id: "Ekspresi tanpa harus sempurna.",
    en: "Expression without perfection.",
  },
  profileName: { id: "Nama Profil", en: "Profile Name" },
  emailAddress: { id: "Alamat Email", en: "Email Address" },
  passwordMin: {
    id: "Password (Min. 6 Karakter)",
  ...
  enterEmailFirst: {
    id: "Masukkan email terlebih dulu.",
    en: "Please enter your email first.",
  },
  resetPasswordSent: {
    id: "Email reset password sudah dikirim. Cek inbox kamu.",
    en: "Password reset email has been sent. Check your inbox.",
  },
  resetPasswordFailed: {
  ...
  whatsYourVibe: {
    id: "Apa vibe kamu sekarang?",
    en: "What's your vibe right now?",
  },
  uploadingMedia: {
    id: "Mengunggah media {progress}%",
    en: "Uploading media {progress}%",
  },
