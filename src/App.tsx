            ...
            {activeTab === 'Feed' ? (
              ...
              <div className="flex flex-col items-start justify-start h-full sm:h-[100dvh] pt-10 px-4 md:px-6 lg:px-8 w-full relative">
                ...
                <div className="relative z-10 w-full flex flex-col">
                  ...
                  <div className="w-20 h-20 sm:w-28 sm:h-28 rounded-full overflow-hidden border-2 border-vibe-muted shrink-0 relative group">
                     <img src={viewingUser.photoURL || ''} alt="Profile" className="w-full h-full object-cover bg-[#050505]" />
                     {isViewingOwnProfile && (
                       <div 
